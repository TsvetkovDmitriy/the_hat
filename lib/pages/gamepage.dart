...
class _GamePageState extends State<GamePage> {
  ...
  Widget build(BuildContext context) {
    ...
    String name = "";
    String teamName = "";
    String bestTeamScore = "";
    String bestPersonalScore = "";
    if (_pageState == _PageStates.finish) {
      ...
      api.game.teamList.forEach((element) {
        if (element.score > teamScore) {
          ...
          bestTeamScore = element.score.toString();
        }
        if (element.score == teamScore) {
          teamName = 'НИЧЬЯ';
        }
        element.playersList.forEach((player) {
          if (player.personalScore > score) {
            ...
            bestPersonalScore = player.personalScore.toString();
          }
        });
      });
    }
    if (_pageState == _PageStates.end) {
      ...
      api.game.teamList.forEach((element) {
        results.add(Text(
          element.name + " - " + element.score.toString(),
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              (isOk ? "  1" : "  -1"),
              style: TextStyle(
                  fontSize: 24, color: isOk ? AppColors.bg : AppColors.pink),
            )
          ],
        ));
  }
